...
class OrderSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Order
        fields = ['id', 'basket_id', 'datetime_ordered', 'user_id', 'total_price', 'shipping_addr'] # date_ordered?
...
class BasketSerializer(serializers.ModelSerializer):
    items = BasketItemsSerializer(many=True, read_only=True, source='basketitem_set') #basketitems_set or basketitem_set?
